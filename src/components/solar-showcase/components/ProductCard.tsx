  ...
  return (
    <div className={cn(
      ...
      <Card className="overflow-hidden hover:shadow-xl transition-all duration-300 h-full bg-white/95 backdrop-blur">
        <div className="aspect-square bg-gradient-to-br from-solar-blue-50 to-white p-8 relative group">
        ...
        <div className="p-8 space-y-6">
          <h3 className="text-2xl font-bold bg-gradient-to-r from-solar-orange to-solar-orange-dark bg-clip-text text-transparent">
            {product.name}
          </h3>
          ...
          <ul className="space-y-3">
            {product.features.map((feature, idx) => (
              <li key={idx} className="flex items-center gap-3 group">
                <div className="w-2 h-2 rounded-full bg-solar-orange group-hover:scale-125 transition-transform" />
